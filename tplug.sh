...
case "$1" in
    add) shift; . "$COMMAND_DIR/add.sh" ;;
    install) shift; . "$COMMAND_DIR/install.sh" ;;
    logs) shift; . "$COMMAND_DIR/logs.sh" ;;
    list-plugins) . "$COMMAND_DIR/list-plugins.sh" ;;
    list-services) . "$COMMAND_DIR/list-services.sh" ;;
    list-available) . "$COMMAND_DIR/list-available.sh" ;;
    remove) shift; . "$COMMAND_DIR/remove.sh" ;;
    remove-plugin) shift; . "$COMMAND_DIR/remove-plugin.sh" ;;
    --help) show_help ;;
    *) show_help ;;
esac
